...
export const TypeButton = styled.button`
  ...
  ${props => props.activeType === 'company' && css`
    &:hover { border-color: #3b82f6; } /* hover:border-blue-500 */
  `}
  ${props => props.activeType === 'staff' && css`
    &:hover { border-color: #6366f1; } /* hover:border-indigo-500 */
  `}
...
export const IconBox = styled.div`
  width: 3rem;
  height: 3rem;
  background-color: ${props => props.color === 'blue' ? 'rgba(59, 130, 246, 0.1)' : 'rgba(99, 102, 241, 0.1)'};
  border-radius: 1rem;
  display: flex;
  align-items: center;
  justify-content: center;
...
export const InfoBox = styled.div`
  background-color: ${props => props.variant === 'blue' ? '#eff6ff' : '#e0e7ff'}; /* bg-blue-50 or indigo-50 */
  padding: 1rem;
  border-radius: 1rem;
  border: 1px solid ${props => props.variant === 'blue' ? '#dbeafe' : '#e0e7ff'};

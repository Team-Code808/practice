...
export const ChartTabButton = styled.button`
  ...
  background-color: ${props => props.active ? props.activeColor || '#334155' : 'transparent'};
...
export const EmptyState = styled.div`
  ...
  svg { color: #64748b; width: 2.5rem; height: 2.5rem; }
  p { font-size: 0.75rem; font-weight: 700; margin-top: 0.5rem; color: #64748b; }
`;
...
export const ModalHeader = styled.div`
  ...
  ${props => props.status === '식사 중' && 'background-color: #059669;'} /* emerald-600 */
  ${props => props.status === '통화 중' && 'background-color: #7c3aed;'} /* violet-600 */
  ${props => props.status === '대기' && 'background-color: #475569;'} /* slate-600 */
  ${props => props.status === '업무 중' && 'background-color: #2563eb;'} /* blue-600 */
`;

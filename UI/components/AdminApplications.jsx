...
import * as S from './AdminApplications.styles';
...
const AdminApplications = () => {
  ...
  const leaveRequests = [
    { id: 1, name: '정태양', dept: '상담 1팀', type: '연차', period: '2024.03.25 - 03.26', status: '대기', reason: '가족 모임 참석', day: 25, avatar: '🧔' },
    { id: 2, name: '서예진', dept: '상담 3팀', type: '반차', period: '2024.03.22 (오후)', status: '대기', reason: '병원 정기 검진', day: 22, avatar: '👩‍🎨' },
    { id: 3, name: '이민수', dept: '상담 1팀', type: '연차', period: '2024.03.15', status: '승인', reason: '개인 사유', day: 15, avatar: '👨‍💼' },
    { id: 4, name: '김지아', dept: '상담 2팀', type: '반차', period: '2024.03.12 (오전)', status: '반려', reason: '업무 폭주 기간', day: 12, avatar: '👩‍💼' },
    { id: 5, name: '박진호', dept: '상담 1팀', type: '연차', period: '2024.03.25', status: '승인', reason: '개인 휴식', day: 25, avatar: '👨‍💻' },
    { id: 6, name: '최우식', dept: '상담 2팀', type: '연차', period: '2024.03.22', status: '대기', reason: '이사 준비', day: 22, avatar: '👨‍🎨' },
    { id: 7, name: '이수민', dept: '개발팀', type: '워케이션', period: '2024.03.27 - 03.28', status: '대기', reason: '제주도 워케이션 근무', day: 27, avatar: '👩‍💻' },
  ];

  const consultationRequests = [
    { id: 101, name: '박진호', dept: '상담 1팀', type: '긴급 상담', time: '2024.03.21 14:30', status: '대기', message: '악성 민원으로 인한 멘탈 케어 필요', day: 21 },
    { id: 102, name: '이지은', dept: '상담 2팀', type: '일반 상담', time: '2024.03.21 15:00', status: '대기', message: '직무 스트레스 및 진로 상담', day: 21 },
    { id: 103, name: '강동원', dept: '상담 1팀', type: '일반 상담', time: '2024.03.20 11:00', status: '완료', message: '업무 조정 관련 면담', day: 20 },
  ];
